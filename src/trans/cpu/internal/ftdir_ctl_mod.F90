...
CONTAINS
  SUBROUTINE FTDIR_CTL(KF_UV_G,KF_SCALARS_G,KF_GP,KF_FS,ZCOMBUFS,ZCOMBUFR,SEND_ID,RECV_ID, &
      & KSENDCOUNT,KNSEND,KRECVCOUNT,KNRECV, &
      & KVSETUV,KVSETSC,KPTRGP,&
      & KVSETSC3A,KVSETSC3B,KVSETSC2,&
      & PGP,PGPUV,PGP3A,PGP3B,PGP2,LUSE_WAITANY)
...
INTEGER(KIND=JPIM),INTENT(IN) :: KF_UV_G,KF_SCALARS_G,KF_GP,KF_FS,SEND_ID(2),RECV_ID(2)
INTEGER(KIND=JPIM),INTENT(IN) :: KSENDCOUNT,KNSEND,KRECVCOUNT,KNRECV
REAL(KIND=JPRB), INTENT(INOUT) :: ZCOMBUFS(-1:KSENDCOUNT,KNSEND)
REAL(KIND=JPRB), INTENT(INOUT) :: ZCOMBUFR(-1:KRECVCOUNT,KNRECV)
...
CALL GSTATS(158,0)
CALL TRGTOL(PIN,KF_FS,KF_GP,KF_SCALARS_G,IVSET,KPTRGP,ZCOMBUFS,ZCOMBUFR,SEND_ID,RECV_ID,&
        & KSENDCOUNT,KNSEND,KRECVCOUNT,KNRECV, PGP,PGPUV,PGP3A,PGP3B,PGP2,LUSE_WAITANY)
