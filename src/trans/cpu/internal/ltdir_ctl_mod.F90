...
CONTAINS
SUBROUTINE LTDIR_CTL(KF_FS,KF_UV,KF_SCALARS, SEND_ID, &
...
INTEGER(KIND=JPIM),INTENT(IN) :: KF_FS,KF_UV,KF_SCALARS,SEND_ID(2)
...
INTEGER(KIND=JPIM) :: JM,IM,IBLEN,ILED2,STATUS
...
CALL GSTATS(153,0)
#ifdef NONPERSISTENT
CALL TRLTOM(FOUBUF_IN,FOUBUF,2*KF_FS,send_id(2))
#endif
CALL PT_REQSET_START(SEND_ID(2),STATUS)
CALL PT_REQSET_WAIT(SEND_ID(2))
CALL GSTATS(153,1)
